...
def run():
        ...
        # Scaling-out
                ...
                response=ec2.run_instances(ImageId='ami-0bf71a62be0455cf0',InstanceType='t2.micro',KeyName='cloud-proj',MinCount=add,MaxCount=add,UserData=user_data,TagSpecifications=[{
